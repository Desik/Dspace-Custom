        ...
        <xsl:if test="dim:field[@element='identifier'][not(@qualifier)]">
          <div class="simple-item-view-identifier item-page-field-wrapper table">
            ...
            <xsl:for-each select="dim:field[@element='identifier'][not(@qualifier)]">
              ...
              <xsl:if test="count(following-sibling::dim:field[@element='identifier'][not(@qualifier)]) != 0"> <br/> </xsl:if>
            </xsl:for-each>
          </div>
        </xsl:if>
    </xsl:template>
        ...
        <xsl:if test="dim:field[@element='type'][not(@qualifier)]">
          <div class="simple-item-view-subject item-page-field-wrapper table">
            ...
            <xsl:for-each select="dim:field[@element='subject'][not(@qualifier)]">
              ...
              <xsl:if test="count(following-sibling::dim:field[@element='subject'][not(@qualifier)]) != 0"> <br/> </xsl:if>
            </xsl:for-each>
          </div>
        </xsl:if>
    </xsl:template>
